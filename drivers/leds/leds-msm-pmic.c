...
static int msm_pmic_led_probe(struct platform_device *pdev)
{
	...
	vreg_keyled = vreg_get(NULL, "ldo17");
		#if defined(CONFIG_MACH_GIO_SKT)||defined(CONFIG_MACH_GIO_KT) //avad_streetlife change VDD_KEY_LED_3.3V(PMIC OUT17) 3.3-> 2.85
		ret = vreg_set_level(vreg_keyled, OUT2850mV); 
		#else
