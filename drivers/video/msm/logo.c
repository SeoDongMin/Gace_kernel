...
int load_565rle_image_onfb( char *filename, int start_x, int start_y)
{
	...
	struct fb_info *info;
#if defined(CONFIG_MACH_CALLISTO) || defined(CONFIG_MACH_COOPER) || defined(CONFIG_MACH_COOPER_BASE_KOR) || defined(CONFIG_MACH_BENI) || defined(CONFIG_MACH_TASS) || defined(CONFIG_MACH_LUCAS)
...
#if defined(CONFIG_MACH_CALLISTO) || defined(CONFIG_MACH_COOPER) || defined(CONFIG_MACH_COOPER_BASE_KOR) || defined(CONFIG_MACH_BENI) || defined(CONFIG_MACH_TASS)
	p_line = bits;
