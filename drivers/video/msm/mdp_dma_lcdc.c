...
#if defined(CONFIG_MACH_TASS) || defined(CONFIG_MACH_BENI) || defined(CONFIG_MACH_LUCAS) || defined(CONFIG_MACH_COOPER) || defined(CONFIG_MACH_COOPER_BASE_KOR) || defined(CONFIG_MACH_CALLISTO)
...
#else
	#if defined(CONFIG_MACH_CALLISTO) || defined(CONFIG_MACH_LUCAS) || defined(CONFIG_MACH_JUNO_SKT) || defined(CONFIG_MACH_JUNO_KT) // minhyo100515
	printk("polarity setting : active low\n"); // minhyodebug
	hsync_polarity = 1; // active low
	vsync_polarity = 1;	// active low
	#else
	printk("polarity setting : active high\n"); // minhyodebug
	hsync_polarity = 0;
	vsync_polarity = 0;
	#endif
#endif
