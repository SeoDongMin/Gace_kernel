...
static void handle_jack_not_inserted(struct sec_jack_info *hi)
{
	...
	hi->pdata->set_micbias_state(false);	//kkuram 2011.02.07 sleep current issue(earphone unplugged)
#else
...
#ifdef SUPPORT_EARADC_CHECK
		adc = hi->pdata->get_adc_value();
		pr_info(MODULE_NAME "sendend adc = %d\n", adc);
#endif
