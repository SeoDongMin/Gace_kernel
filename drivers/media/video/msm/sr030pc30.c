...
static char sr030pc30_sensor_init_done = 1;

//Gopeace LeeSangmin DJ26 add
static unsigned short sr030pc30_sensor_version = 0xff;

struct sr030pc30_work {
	struct work_struct work;
};

static struct  sr030pc30_work *sr030pc30_sensorw;
static struct  i2c_client *sr030pc30_client;

struct sr030pc30_ctrl 
{
...
static struct sr030pc30_ctrl *sr030pc30_ctrl;
static struct sr030pc30_data_save sr030pc30_data;
...
static inline int sr030pc30_sensor_read( unsigned char subaddr, unsigned char *data)
{
	...
	{
		dev_err(&sr030pc30_client->dev, "%s: %d can't search i2c client adapter\n", __func__, __LINE__);
		return -EIO;
	} 
	...
	err = i2c_transfer(sr030pc30_client->adapter, &msg, 1);
	if (unlikely(err < 0))
	{
		dev_err(&sr030pc30_client->dev, "%s: %d register read fail\n", __func__, __LINE__);	
		return -EIO;
	}
...
static int sr030pc30_sensor_write( unsigned char subaddr, unsigned char val)
{
	unsigned char buf[2];
	struct i2c_msg msg = { sr030pc30_client->addr, 0, 2, buf };

	//printk("[PGH] on write func sr030pc30_client->addr : %x\n", sr030pc30_client->addr);
	//printk("[PGH] on write func sr030pc30_client->adapter->nr : %d\n", sr030pc30_client->adapter->nr);
...
static int sr030pc30_sensor_write_tunning_data( unsigned short code)
{
	...
	return sr030pc30_sensor_write( subaddr, val);
}


static int sr030pc30_sensor_write_list( const unsigned short *regs, int size, char *name)
{
	int i = 0, ret = 0;

    printk("sr030pc30_sensor_write_list name=%s, size=%d \n", name, size);
	...
	for( i = 0; i < size; i++) 
	{
		//printk("sr030pc30_sensor_write_tunning_data reg[%d] : 0x%x\n", i, regs[i]);
		if( sr030pc30_sensor_write_tunning_data( regs[i]))
		{
...
void sr030pc30_effect_control( char value)
{
	switch( value)
	{
		case EXT_CFG_EFFECT_NORMAL :
		{
			...
			sr030pc30_sensor_write_list( sr030pc30_Effect_Normal, SR030PC30_EFFECT_NORMAL_REGS,\
			 "sr030pc30_Effect_Normal"); 
		}
		break;		
		...
		case EXT_CFG_EFFECT_NEGATIVE :
		{
			...
			sr030pc30_sensor_write_list( sr030pc30_Effect_Negative, SR030PC30_EFFECT_NEGATIVE_REGS,\
		...
		case EXT_CFG_EFFECT_MONO :
		{
			...
			sr030pc30_sensor_write_list( sr030pc30_Effect_Black_White, SR030PC30_EFFECT_BLACK_WHITE_REGS,\
			 "sr030pc30_Effect_Black_White"); 
		}
		break;	
		...
		case EXT_CFG_EFFECT_SEPIA :
		{
			...
			sr030pc30_sensor_write_list( sr030pc30_Effect_Sepia, SR030PC30_EFFECT_SEPIA_REGS,\
...
/*
		case EXT_CFG_EFFECT_GREEN :
		{
			...
			sr030pc30_sensor_write_list( sr030pc30_Effect_Green, SR030PC30_EFFECT_GREEN_REGS,\
			 "sr030pc30_Effect_Green"); 
		}
		break;	
		...
		case EXT_CFG_EFFECT_AQUA :
		{
			...
			sr030pc30_sensor_write_list( sr030pc30_Effect_Aqua, SR030PC30_EFFECT_AQUA_REGS,\
			 "sr030pc30_Effect_Aqua"); 
		}
		break;	
*/
		default :
...
void sr030pc30_pretty_control( char value)
{
	switch( value)
	{
		case EXT_CFG_PRETTY_LEVEL_0:
		{
			...
			sr030pc30_sensor_write_list( sr030pc30_Pretty_Level_0, SR030PC30_PRETTY_LEVEL_0_REGS,\
			 "sr030pc30_Pretty_Level_0"); 
		}
		break;		
		...
		case EXT_CFG_PRETTY_LEVEL_1:
		{
			...
			sr030pc30_sensor_write_list( sr030pc30_Pretty_Level_1, SR030PC30_PRETTY_LEVEL_1_REGS,\
			 "sr030pc30_Pretty_Level_1"); 
		}
		break;	
		...
		case EXT_CFG_PRETTY_LEVEL_2:
		{
			...
			sr030pc30_sensor_write_list( sr030pc30_Pretty_Level_2, SR030PC30_PRETTY_LEVEL_2_REGS,\
			 "sr030pc30_Pretty_Level_2"); 
		}
		break;	
		...
		case EXT_CFG_PRETTY_LEVEL_3:
		{
			...
			sr030pc30_sensor_write_list( sr030pc30_Pretty_Level_3, SR030PC30_PRETTY_LEVEL_3_REGS,\
			 "sr030pc30_Pretty_Level_3"); 
		}
		break;	
...
void sr030pc30_VT_pretty_control( char value)
{
	switch( value)
	{
		case EXT_CFG_PRETTY_LEVEL_0:
		{
			CAMDRV_DEBUG( "EXT_CFG_PRETTY_LEVEL_0");
			sr030pc30_sensor_write_list( sr030pc30_VT_Pretty_Level_0, SR030PC30_VT_PRETTY_LEVEL_0_REGS,\
			 "sr030pc30_VT_Pretty_Level_0"); 
		}
		break;		
		...
		{
			CAMDRV_DEBUG( "EXT_CFG_PRETTY_LEVEL_1");
			sr030pc30_sensor_write_list( sr030pc30_VT_Pretty_Level_1, SR030PC30_VT_PRETTY_LEVEL_1_REGS,\
			 "sr030pc30_VT_Pretty_Level_1"); 
		}
		break;	
		...
		{
			CAMDRV_DEBUG( "EXT_CFG_PRETTY_LEVEL_2");
			sr030pc30_sensor_write_list( sr030pc30_VT_Pretty_Level_2, SR030PC30_VT_PRETTY_LEVEL_2_REGS,\
			 "sr030pc30_VT_Pretty_Level_2"); 
		}
		break;	
		...
		{
			CAMDRV_DEBUG( "EXT_CFG_PRETTY_LEVEL_3");
			sr030pc30_sensor_write_list( sr030pc30_VT_Pretty_Level_3, SR030PC30_VT_PRETTY_LEVEL_3_REGS,\
			 "sr030pc30_VT_Pretty_Level_3"); 
		}
		break;	
...
void sr030pc30_whitebalance_control(char value)
{
	...
	switch(value)
	{
		...
		sr030pc30_sensor_write_list( sr030pc30_WB_Auto, SR030PC30_WB_AUTO_REGS,\
		 "sr030pc30_WB_Auto"); 
		}
		break;	
		...
		sr030pc30_sensor_write_list( sr030pc30_WB_Daylight, SR030PC30_WB_DAYLIGHT_REGS,\
		 "sr030pc30_WB_Daylight"); 
		}
		break;	

		case EXT_CFG_WB_CLOUDY :{
		CAMDRV_DEBUG( "EXT_CFG_WB_CLOUDY");
		sr030pc30_sensor_write_list( sr030pc30_WB_Cloudy, SR030PC30_WB_CLOUDY_REGS,\
		 "sr030pc30_WB_Cloudy"); 
		}
		break;	
		...
		sr030pc30_sensor_write_list( sr030pc30_WB_Fluorescent, SR030PC30_WB_FLUORESCENT_REGS,\
		...
		sr030pc30_sensor_write_list( sr030pc30_WB_Incandescent, SR030PC30_WB_INCANDESCENT_REGS,\
		 "sr030pc30_WB_Incandescent"); 
		}
		break;	
...
void sr030pc30_VT_brightness_control(char value)
{
	...
	switch(value)
	{
		...
		sr030pc30_sensor_write_list(sr030pc30_VT_brightness_p_4, SR030PC30_VT_BRIGHTNESS_P_4_REGS,\
		 "sr030pc30_VT_brightness_p_4"); 
		}
		break;

		case EXT_CFG_BR_STEP_P_3 :{
		CAMDRV_DEBUG("EXT_CFG_BR_STEP_P_3");
		sr030pc30_sensor_write_list(sr030pc30_VT_brightness_p_3, SR030PC30_VT_BRIGHTNESS_P_3_REGS,\
		 "sr030pc30_VT_brightness_p_3"); 
		}
		break;

		case EXT_CFG_BR_STEP_P_2 :{
		CAMDRV_DEBUG("EXT_CFG_BR_STEP_P_2");
		sr030pc30_sensor_write_list(sr030pc30_VT_brightness_p_2, SR030PC30_VT_BRIGHTNESS_P_2_REGS,\
		 "sr030pc30_VT_brightness_p_2"); 
		}
		break;

		case EXT_CFG_BR_STEP_P_1 :{
		CAMDRV_DEBUG("EXT_CFG_BR_STEP_P_1");
		sr030pc30_sensor_write_list(sr030pc30_VT_brightness_p_1, SR030PC30_VT_BRIGHTNESS_P_1_REGS,\
		 "sr030pc30_VT_brightness_p_1"); 
		}
		break;

		case EXT_CFG_BR_STEP_0 :{
		CAMDRV_DEBUG("EXT_CFG_BR_STEP_0");
		sr030pc30_sensor_write_list(sr030pc30_VT_brightness_0, SR030PC30_VT_BRIGHTNESS_0_REGS, \
		"sr030pc30_VT_brightness_0"); 
		}
		break;

		case EXT_CFG_BR_STEP_M_1 :{
		CAMDRV_DEBUG("EXT_CFG_BR_STEP_M_1");
		sr030pc30_sensor_write_list(sr030pc30_VT_brightness_m_1, SR030PC30_VT_BRIGHTNESS_M_1_REGS, \
		"sr030pc30_VT_brightness_m_1"); 
		}
		break;

		case EXT_CFG_BR_STEP_M_2 :{
		CAMDRV_DEBUG("EXT_CFG_BR_STEP_M_2");
		sr030pc30_sensor_write_list(sr030pc30_VT_brightness_m_2, SR030PC30_VT_BRIGHTNESS_M_2_REGS, \
		"sr030pc30_VT_brightness_m_2"); 
		}
		break;

		case EXT_CFG_BR_STEP_M_3 :{
		CAMDRV_DEBUG("EXT_CFG_BR_STEP_M_3");
		sr030pc30_sensor_write_list(sr030pc30_VT_brightness_m_3, SR030PC30_VT_BRIGHTNESS_M_3_REGS, \
		"sr030pc30_VT_brightness_m_3"); 
		}
		break;

		case EXT_CFG_BR_STEP_M_4 :{
		CAMDRV_DEBUG("EXT_CFG_BR_STEP_M_4");
		sr030pc30_sensor_write_list(sr030pc30_VT_brightness_m_4, SR030PC30_VT_BRIGHTNESS_M_4_REGS, \
		"sr030pc30_VT_brightness_m_4"); 
		}
		break;
...
void sr030pc30_brightness_control(char value)
{
	...
	switch(value)
	{
		case EXT_CFG_BR_STEP_P_4 :{
		CAMDRV_DEBUG("EXT_CFG_BR_STEP_P_4");
		sr030pc30_sensor_write_list(sr030pc30_brightness_p_4, SR030PC30_BRIGHTNESS_P_4_REGS,\
		 "sr030pc30_brightness_p_4"); 
		}
		break;

		case EXT_CFG_BR_STEP_P_3 :{
		CAMDRV_DEBUG("EXT_CFG_BR_STEP_P_3");
		sr030pc30_sensor_write_list(sr030pc30_brightness_p_3, SR030PC30_BRIGHTNESS_P_3_REGS,\
		 "sr030pc30_brightness_p_3"); 
		}
		break;

		case EXT_CFG_BR_STEP_P_2 :{
		CAMDRV_DEBUG("EXT_CFG_BR_STEP_P_2");
		sr030pc30_sensor_write_list(sr030pc30_brightness_p_2, SR030PC30_BRIGHTNESS_P_2_REGS,\
		 "sr030pc30_brightness_p_2"); 
		}
		break;

		case EXT_CFG_BR_STEP_P_1 :{
		CAMDRV_DEBUG("EXT_CFG_BR_STEP_P_1");
		sr030pc30_sensor_write_list(sr030pc30_brightness_p_1, SR030PC30_BRIGHTNESS_P_1_REGS,\
		 "sr030pc30_brightness_p_1"); 
		}
		break;

		case EXT_CFG_BR_STEP_0 :{
		CAMDRV_DEBUG("EXT_CFG_BR_STEP_0");
		sr030pc30_sensor_write_list(sr030pc30_brightness_0, SR030PC30_BRIGHTNESS_0_REGS, \
		"sr030pc30_brightness_0"); 
		}
		break;

		case EXT_CFG_BR_STEP_M_1 :{
		CAMDRV_DEBUG("EXT_CFG_BR_STEP_M_1");
		sr030pc30_sensor_write_list(sr030pc30_brightness_m_1, SR030PC30_BRIGHTNESS_M_1_REGS, \
		"sr030pc30_brightness_m_1"); 
		}
		break;

		case EXT_CFG_BR_STEP_M_2 :{
		CAMDRV_DEBUG("EXT_CFG_BR_STEP_M_2");
		sr030pc30_sensor_write_list(sr030pc30_brightness_m_2, SR030PC30_BRIGHTNESS_M_2_REGS, \
		"sr030pc30_brightness_m_2"); 
		}
		break;

		case EXT_CFG_BR_STEP_M_3 :{
		CAMDRV_DEBUG("EXT_CFG_BR_STEP_M_3");
		sr030pc30_sensor_write_list(sr030pc30_brightness_m_3, SR030PC30_BRIGHTNESS_M_3_REGS, \
		"sr030pc30_brightness_m_3"); 
		}
		break;

		case EXT_CFG_BR_STEP_M_4 :{
		CAMDRV_DEBUG("EXT_CFG_BR_STEP_M_4");
		sr030pc30_sensor_write_list(sr030pc30_brightness_m_4, SR030PC30_BRIGHTNESS_M_4_REGS, \
		"sr030pc30_brightness_m_4"); 
		}
		break;
...
void sr030pc30_FPS_control(char value)
{
	printk("sr030pc30_FPS_control() value:%d", value );
	...
	switch( value)
	{
		...
		case EXT_CFG_FRAME_FIX_15 :
		{
			...
			sr030pc30_sensor_write_list( sr030pc30_15_fps, SR030PC30_15_FPS_REGS,\
			 "sr030pc30_15_fps"); 	
		}
		break;
		...
		case EXT_CFG_FRAME_FIX_10 :
		{
			...
			sr030pc30_sensor_write_list( sr030pc30_10_fps, SR030PC30_10_FPS_REGS,\
			 "sr030pc30_10_fps"); 	
		}
		break;
		...
		case EXT_CFG_FRAME_FIX_7 :
		{
			...
			sr030pc30_sensor_write_list( sr030pc30_7_fps, SR030PC30_7_FPS_REGS,\
			 "sr030pc30_7_fps"); 	
		}
		break;
...
void sr030pc30_VT_FPS_control(char value)
{
	printk("sr030pc30_VT_FPS_control() value:%d", value );
	...
	switch( value)
	{
		...
		{
			CAMDRV_DEBUG( "EXT_CFG_FRAME_FIX_15\n");		
			sr030pc30_sensor_write_list( sr030pc30_VT_15_fps, SR030PC30_VT_15_FPS_REGS,\
			 "sr030pc30_15_fps"); 	
		}
		break;
		...
		{
			CAMDRV_DEBUG( "EXT_CFG_FRAME_FIX_10\n");		
			sr030pc30_sensor_write_list( sr030pc30_VT_10_fps, SR030PC30_VT_10_FPS_REGS,\
			 "sr030pc30_10_fps"); 	
		}
		break;
		...
		{
			CAMDRV_DEBUG( "EXT_CFG_FRAME_FIX_7\n");		
			sr030pc30_sensor_write_list( sr030pc30_VT_7_fps, SR030PC30_VT_7_FPS_REGS,\
			 "sr030pc30_7_fps"); 	
		}
		break;
...
void sensor_metering_control(char value)
{
	...
	switch(value)
	{
		...
		sr030pc30_sensor_write_list(sr030pc30_metering_normal, S5K5CA_METERING_NORMAL_REGS, \
		"sr030pc30_metering_normal"); 
		}
		break;
		
		case EXT_CFG_METERING_SPOT :{
		CAMDRV_DEBUG("EXT_CFG_METERING_SPOT");
		sr030pc30_sensor_write_list(sr030pc30_metering_spot, S5K5CA_METERING_SPOT_REGS, \
		"sr030pc30_metering_spot"); 
		}
		break;

		case EXT_CFG_METERING_CENTER :{
		CAMDRV_DEBUG("EXT_CFG_METERING_CENTER");
		sr030pc30_sensor_write_list(sr030pc30_metering_center, S5K5CA_METERING_CENTER_REGS, \
		"sr030pc30_metering_center"); 
		}
		break;
...
void sensor_contrast_control(char value)
{
	...
	switch(value)
	{
		...
		sr030pc30_sensor_write_list(sr030pc30_contrast_m_2 , S5K5CA_CONTRAST_M_2_REGS, \
		"sr030pc30_contrast_m_2"); 					
		}
		break;

		case EXT_CFG_CR_STEP_M_1 :{
		CAMDRV_DEBUG("EXT_CFG_CR_STEP_P_1");
		sr030pc30_sensor_write_list(sr030pc30_contrast_m_1 , S5K5CA_CONTRAST_M_1_REGS, \
		"sr030pc30_contrast_m_1"); 					
		}
		break;

		case EXT_CFG_CR_STEP_0 :{
		CAMDRV_DEBUG("EXT_CFG_CR_STEP_0");
		sr030pc30_sensor_write_list(sr030pc30_contrast_0 , S5K5CA_CONTRAST_0_REGS, \
		"sr030pc30_contrast_0"); 					
		}
		break;

		case EXT_CFG_CR_STEP_P_1 :{
		CAMDRV_DEBUG("EXT_CFG_CR_STEP_P_1");
		sr030pc30_sensor_write_list(sr030pc30_contrast_p_1 , S5K5CA_CONTRAST_P_1_REGS, \
		"sr030pc30_contrast_p_1"); 					
		}
		break;

		case EXT_CFG_CR_STEP_P_2 :{
		CAMDRV_DEBUG("EXT_CFG_CR_STEP_P_2");
		sr030pc30_sensor_write_list(sr030pc30_contrast_p_2 , S5K5CA_CONTRAST_P_2_REGS, \
		"sr030pc30_contrast_p_2"); 					
		}
		break;
...
void sensor_saturation_control(char value)
{
	...
	switch(value)
	{
		...
		sr030pc30_sensor_write_list(sr030pc30_saturation_m_2 , S5K5CA_SATURATION_M_2_REGS, \
		"sr030pc30_saturation_m_2"); 					
		}
		break;

		case EXT_CFG_SA_STEP_M_1 :{
		CAMDRV_DEBUG("EXT_CFG_SA_STEP_P_1");
		sr030pc30_sensor_write_list(sr030pc30_saturation_m_1 , S5K5CA_SATURATION_M_1_REGS, \
		"sr030pc30_saturation_m_1"); 					
		}
		break;

		case EXT_CFG_SA_STEP_0 :{
		CAMDRV_DEBUG("EXT_CFG_SA_STEP_0");
		sr030pc30_sensor_write_list(sr030pc30_saturation_0 , S5K5CA_SATURATION_0_REGS, \
		"sr030pc30_saturation_0"); 					
		}
		break;

		case EXT_CFG_SA_STEP_P_1 :{
		CAMDRV_DEBUG("EXT_CFG_SA_STEP_P_1");
		sr030pc30_sensor_write_list(sr030pc30_saturation_p_1 , S5K5CA_SATURATION_P_1_REGS, \
		"sr030pc30_saturation_p_1"); 					
		}
		break;

		case EXT_CFG_SA_STEP_P_2 :{
		CAMDRV_DEBUG("EXT_CFG_SA_STEP_P_2");
		sr030pc30_sensor_write_list(sr030pc30_saturation_p_2 , S5K5CA_SATURATION_P_2_REGS, \
		"sr030pc30_saturation_p_2"); 					
		}
		break;
...
void sensor_sharpness_control(char value)
{
	...
	switch(value)
	{
		...
		sr030pc30_sensor_write_list(sr030pc30_sharpness_m_2 , S5K5CA_SHARPNESS_M_2_REGS, \
		"sr030pc30_sharpness_m_2"); 					
		}
		break;

		case EXT_CFG_SP_STEP_M_1 :{
		CAMDRV_DEBUG("EXT_CFG_SP_STEP_P_1");
		sr030pc30_sensor_write_list(sr030pc30_sharpness_m_1 , S5K5CA_SHARPNESS_M_1_REGS, \
		"sr030pc30_sharpness_m_1"); 					
		}
		break;

		case EXT_CFG_SP_STEP_0 :{
		CAMDRV_DEBUG("EXT_CFG_SP_STEP_0");
		sr030pc30_sensor_write_list(sr030pc30_sharpness_0 , S5K5CA_SHARPNESS_0_REGS, \
		"sr030pc30_sharpness_0"); 					
		}
		break;

		case EXT_CFG_SP_STEP_P_1 :{
		CAMDRV_DEBUG("EXT_CFG_SP_STEP_P_1");
		sr030pc30_sensor_write_list(sr030pc30_sharpness_p_1 , S5K5CA_SHARPNESS_P_1_REGS, \
		"sr030pc30_sharpness_p_1"); 					
		}
		break;

		case EXT_CFG_SP_STEP_P_2 :{
		CAMDRV_DEBUG("EXT_CFG_SP_STEP_P_2");
		sr030pc30_sensor_write_list(sr030pc30_sharpness_p_2 , S5K5CA_SHARPNESS_P_2_REGS, \
		"sr030pc30_sharpness_p_2"); 					
		}
		break;
...
static void sr030pc30_set_power( int status)
{
	...
	{
		CAMDRV_DEBUG("sr030pc30_set_power : POWER ON");
	...
	{
		CAMDRV_DEBUG("sr030pc30_set_power : POWER OFF");
...
#if 1
void sr030pc30_DTP_control( char value)
{
	switch( value)
	{
		case EXT_CFG_DTP_OFF:
		{
			...
			sr030pc30_data.mDTP = 0;
			sr030pc30_sensor_write_list( sr030pc30_dtp_off, SR030PC30_DTP_OFF_REGS, "sr030pc30_dtp_off");
			//sr030pc30_reset();
		}
		break;
		...
		{
			CAMDRV_DEBUG( "DTP ON");
			sr030pc30_data.mDTP = 1;
			sr030pc30_sensor_write_list( sr030pc30_dtp_on, SR030PC30_DTP_ON_REGS, "sr030pc30_dtp_on");
		}
		break;
...
int sr030pc30_sensor_ext_config(void __user *arg)
{
	long   rc = 0;
	...
	switch(ctrl_info.mode)
	{
		...
		{
			sr030pc30_data.mFPS = ctrl_info.value_1;
			if( 0 == sr030pc30_data.mVtMode)
				sr030pc30_FPS_control( sr030pc30_data.mFPS);
			if( 1 == sr030pc30_data.mVtMode)
				sr030pc30_VT_FPS_control( sr030pc30_data.mFPS);
		}
		break;

		case EXT_CFG_EFFECT_CONTROL:
		{
			sr030pc30_data.mEffect = ctrl_info.value_1;
			sr030pc30_effect_control( sr030pc30_data.mEffect);
		}// end of EXT_CFG_EFFECT_CONTROL
		break;

		case EXT_CFG_WB_CONTROL:
		{
			sr030pc30_data.mWhiteBalance = ctrl_info.value_1;
			sr030pc30_whitebalance_control( sr030pc30_data.mWhiteBalance);
		}//end of EXT_CFG_WB_CONTROL
		break;

		case EXT_CFG_BR_CONTROL:
		{
			sr030pc30_data.mBrightness = ctrl_info.value_1;
			//if(mInit)
			if( 0 == sr030pc30_data.mVtMode)
				sr030pc30_brightness_control( sr030pc30_data.mBrightness);
			if( 1 == sr030pc30_data.mVtMode)
				sr030pc30_VT_brightness_control( sr030pc30_data.mBrightness);
		...
		{
			sr030pc30_data.mISO = ctrl_info.value_1;
		...
		{
			sr030pc30_data.mAutoExposure = ctrl_info.value_1;
		...
		case EXT_CFG_AE_AWB_CONTROL:
		{
			...
			switch(ctrl_info.value_1)
			{
				...
				sr030pc30_sensor_write_list(sr030pc30_awb_ae_lock , S5K5CA_AWB_AE_LOCK_REGS, \
				"sr030pc30_awb_ae_lock"); 					
				}
				break;

				case EXT_CFG_AWB_AE_UNLOCK :{
				CAMDRV_DEBUG("EXT_CFG_AWB_AE_UNLOCK");
				sr030pc30_sensor_write_list(sr030pc30_awb_ae_unlock , S5K5CA_AWB_AE_UNLOCK_REGS, \
				"sr030pc30_awb_ae_unlock"); 
		...
		{
			sr030pc30_data.mPrettyEffect = ctrl_info.value_1;
			if( 0 == sr030pc30_data.mVtMode)
				sr030pc30_pretty_control( sr030pc30_data.mPrettyEffect);
			if( 1 == sr030pc30_data.mVtMode)
				sr030pc30_VT_pretty_control( sr030pc30_data.mPrettyEffect);
		}
		break;
			
		case EXT_CFG_CR_CONTROL:
		{
			sr030pc30_data.mContrast = ctrl_info.value_1;
			//if(mInit)
		...
		{
			sr030pc30_data.mSaturation = ctrl_info.value_1;
			//if(mInit)
		...
		{
			sr030pc30_data.mSharpness = ctrl_info.value_1;
			//if(mInit)
		...
		{
			sr030pc30_DTP_control( ctrl_info.value_1);
		...
		default :{
			printk("<=PCAM=> Unexpected mode on sr030pc30_sensor_control : %d\n", ctrl_info.mode);
		}
		break;
	}
...
/*===========================================================================
FUNCTION      CAMSENSOR_sr030pc30_CHECK_SENSOR_REV
===========================================================================*/
...
static unsigned char sr030pc30_check_sensor_rev( void)
{
    ...
    sr030pc30_sensor_version = 0xff;
    
    ret0 = sr030pc30_sensor_write( 0x03, 0x00);
	ret1 = sr030pc30_sensor_read( 0x04, &id);
    
  	printk("sr030pc30_check_sensor_rev!!! ret0:%d ret1:%d\n",ret0,ret1);
  
    if( id == 0x8c )
    {
        printk("============================\n");
        printk("[cam] SR030PC30				\n");
        printk("============================\n");

        sr030pc30_sensor_version 	= 0x8c; //SR030PC30
    }
    else 
    {
		...
		else
		{
			...
			sr030pc30_sensor_version = 0xFF; //No sensor
		}
    }
    return sr030pc30_sensor_version;
}

static int sr030pc30_hw_init()
{

	int rc = 0;
    unsigned short	id = 0; //CAM FOR FW

    CAMDRV_DEBUG("next sr030pc30_hw_init");

    id = sr030pc30_check_sensor_rev();
...
static long sr030pc30_set_effect(int mode, int effect)
{
    ...
    sr030pc30_effect = effect;

    return rc;
}


static int sr030pc30_debugprint_preview_data( void)
{
	unsigned char read_value = 0;

	printk( "sr030pc30_preview start\n");
	printk( "==============================\n");
	sr030pc30_sensor_write( 0xef, 0x03);
	sr030pc30_sensor_read( 0x33, &read_value);
	printk("Normal Light Contrast : 0x%2x\n", read_value);
	sr030pc30_sensor_read( 0x34, &read_value);
	printk("Low Light Contrast    : 0x%2x\n", read_value);
	sr030pc30_sensor_read( 0x01, &read_value);
	printk("AE Target             : 0x%2x\n", read_value);
	sr030pc30_sensor_read( 0x02, &read_value);
	printk("AE Threshold          : 0x%2x\n", read_value);
	sr030pc30_sensor_read( 0x67, &read_value);
...
static int sr030pc30_start_preview( void)
{
	sr030pc30_debugprint_preview_data();


	if( sr030pc30_data.mDTP == 1)
	{
		sr030pc30_sensor_write_list( sr030pc30_init_reg, SR030PC30_INIT_REGS, "sr030pc30_init_reg");     
		sr030pc30_sensor_write_list( sr030pc30_dtp_on, SR030PC30_DTP_ON_REGS, "sr030pc30_dtp_on");
	}
	else
	{
		sr030pc30_DTP_control( EXT_CFG_DTP_OFF);
		
		if( 0 == sr030pc30_data.mVtMode)
		{
			printk( "sr030pc30 Normal Preview start");
			sr030pc30_sensor_write_list( sr030pc30_init_reg, SR030PC30_INIT_REGS, "sr030pc30_init_reg");     
		}
		else if( 1 == sr030pc30_data.mVtMode)
		{
			printk( "sr030pc30 VtMode Preview start");
			sr030pc30_sensor_write_list( sr030pc30_VT_init_reg, SR030PC30_VT_INIT_REGS, "sr030pc30_VT_init_reg"); 
...
{
	printk( "sr030pc30_set_sensor_mode start : %d\n", mode);
...
static int sr030pc30_regs_table_write(char *name)
{
    ...
    printk("sr030pc30_regs_table_write name=%s \n", name);
	...
	*(data_buf + 6) = '\0';
	...
	while (1) {	
		...
		if (reg != NULL) {
			...
			{
    			if(sr030pc30_sensor_write_tunning_data(value) < 0)
				{
...
int sr030pc30_sensor_init(const struct msm_camera_sensor_info *data)
{
	...
	sr030pc30_ctrl = kzalloc(sizeof(struct sr030pc30_ctrl), GFP_KERNEL);
	if (!sr030pc30_ctrl) {
...
int sr030pc30_sensor_config(void __user *argp)
{
	...
	CDBG("sr030pc30_ioctl, cfgtype = %d, mode = %d\n",
...
int sr030pc30_sensor_release(void)
{
	...
	sr030pc30_data.mEffect = 0;
	sr030pc30_data.mBrightness = 0;
	sr030pc30_data.mContrast = 0;
	sr030pc30_data.mSaturation = 0;
	sr030pc30_data.mSharpness = 0;
	sr030pc30_data.mWhiteBalance = 0;
	sr030pc30_data.mISO = 0;
	sr030pc30_data.mAutoExposure = 0;
	//sr030pc30_data.mScene = 0;
	//mAfMode = 0;
	sr030pc30_data.mDTP = 0;
	sr030pc30_data.mInit = 0;
	sr030pc30_data.mFPS = 0;

	printk("<=PCAM=> sr030pc30_sensor_release\n");
	...
	const struct i2c_device_id *id)
{
	...
	sr030pc30_sensorw =
		kzalloc(sizeof(struct sr030pc30_work), GFP_KERNEL);
	...
	printk("sr030pc30_probe succeeded!\n");
				...
				struct msm_sensor_ctrl *s)
{
	...
	if (rc < 0 || sr030pc30_sensorw == NULL) {
		rc = -ENOTSUPP;
		goto probe_done;
	}
...
*/
	...
	s->s_ext_config = sr030pc30_sensor_ext_config; // for samsung camsensor control
