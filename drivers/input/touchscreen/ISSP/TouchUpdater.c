...
#elif defined(CONFIG_MACH_GIO_SKT) || defined(CONFIG_MACH_GIO_KT) || defined(CONFIG_MACH_JUNO_SKT) || defined(CONFIG_MACH_JUNO_KT)
#include "Firmware_GIO07_HW03.h"
#elif defined(CONFIG_MACH_COOPER_SKT) || defined (CONFIG_MACH_COOPER_KT)
#include "Firmware_cooper07_HW04.h"
#else
#include "Firmware_cooper06_HW04.h"
#endif
};
unsigned char Firmware_Data_HW35[]= 
{
#if defined(CONFIG_MACH_GIO_SKT) || defined (CONFIG_MACH_GIO_KT)
#include "Firmware_GIO07_HW35.h"
#endif
};
...
int cypress_update( int HW_ver )
{
    ...
    if( HW_ver == 3 || HW_ver == 1 || HW_ver == 2 )
		pSocData = Firmware_Data_HW3;
    else if( HW_ver == 35 )
		pSocData = Firmware_Data_HW35;        
