...
static DEVICE_ATTR(firmware_ret	, S_IRUGO | S_IWUSR , firmware_ret_show, firmware_ret_store);
#if defined(CONFIG_MACH_COOPER_BASE_KOR)
static DEVICE_ATTR(set_tsp_for_inputmethod, S_IRUGO | S_IWUSR , set_tsp_for_inputmethod_show, set_tsp_for_inputmethod_store);
#endif
#if defined(CONFIG_MACH_COOPER_SKT)
static DEVICE_ATTR(set_tsp_for_noise, S_IRUGO | S_IWUSR , set_tsp_for_noise_show, set_tsp_for_noise_store);
#endif
*/
