...
//int qt_power_control(boolean OnOff);
...
int qt_power_control(int OnOff)
{
...
//yichoi_temp extern charging_boot;
...
#if 0
{
    ...
    quantum_touch_probe();
 	 ...
 	 set_irq_type(qt602240->client->irq, IRQ_TYPE_LEVEL_LOW);//IRQ_TYPE_LEVEL_LOW); // IRQ_TYPE_EDGE_FALLING);
// 	 set_irq_type(qt602240->client->irq, IRQF_TRIGGER_FALLING); // IRQ_TYPE_EDGE_FALLING);

//    s3c_gpio_cfgpin(TSP_INT, S3C_GPIO_SFN(0xf));

//	set_irq_type(TSP_INT, IRQ_TYPE_LEVEL_LOW); // IRQ_TYPE_EDGE_FALLING);
