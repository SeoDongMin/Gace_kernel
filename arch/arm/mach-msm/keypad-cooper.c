...
static unsigned int keypad_row_gpios_03[] = { 42, 41 };
static unsigned int keypad_col_gpios_03[] = { 35, 34 };
#else
// Cooper H/W REV 03 Keypad
...
static unsigned short keypad_keymap_surf_03[ARRAY_SIZE(keypad_row_gpios_03) *
	...
	[KEYMAP_INDEX_03(0, 1)] = KEY_VOLUMEDOWN,
	[KEYMAP_INDEX_03(1, 0)] = KEY_HOME,
#if SCAN_FUNCTION_KEYS
